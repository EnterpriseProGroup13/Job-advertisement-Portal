...
const Signup = () => {
    ...
    const countries = [
        "USA", "Canada", "Australia", "India", "United Kingdom", "Germany", "France", "Brazil", "Japan", "China" // Add your countries here
    ];
    ...
    const submitHandler = async (e) => {
        ...
        formData.append("location", input.location); // Include location in form data
        if (input.file) {
